...
struct Enviament {
    ...
    friend istream& operator>> (istream& in, Enviament& env) {
        in >> env.dni >> env.exer >> env.temps >> env.res;
        return in;
    }
};
...
int main () {
    ...
    cout << "alumne amb mes enviaments verds:     " << dni_mx_env_verds;
    if (mx_env_verds) cout << " (" << mx_env_verds << ')';
    cout << endl << "alumne amb mes exercicis verds:      " << dni_mx_verds;
    if (mx_verds) cout << " (" << mx_verds << ')';
    cout << endl << "alumne amb mes exercicis vermells:   " << dni_mx_vermells;
    if (mx_vermells) cout << " (" << mx_vermells << ')';
    cout << endl << "alumne amb mes exercicis intentats:  " << dni_mx_intents;
    if (mx_intents) cout << " (" << mx_intents << ')';
    cout << endl << "alumne que ha fet l'ultim enviament: " << dni_last << endl;
}
